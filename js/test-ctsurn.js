...
testMethod(versionPassage, "urn.getPassage()", versionPassage.toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:24.111" );

// getPassage()
targetElement.innerHTML += `<h3>getPassage()</h3>`;

testMethod(passageUrn, "urn.getPassage()", passageUrn.getPassage() == "1.1" );

testMethod(workUrn, "urn.getPassage()", workUrn.getPassage() == "" );

testMethod(rangeUrn, "urn.getPassage()", rangeUrn.getPassage() == "1.1-3.3" );
...
testMethod(passageUrn, `urn.dropPassage() ${passageUrn} -> "urn:cts:greekLit:tlg0012.tlg001.allen.token:"`, passageUrn.dropPassage().equals("urn:cts:greekLit:tlg0012.tlg001.allen.token:") );

// replacePassage()
targetElement.innerHTML += `<h3>replacePassage()</h3>`;

testMethod(passageUrn, `urn.replacePassage("2.2"}): ${passageUrn} -> "urn:cts:greekLit:tlg0012.tlg001.allen.token:2.2"`, passageUrn.replacePassage("2.2").equals("urn:cts:greekLit:tlg0012.tlg001.allen.token:2.2") );

// splitRange()
targetElement.innerHTML += `<h3>splitRange()</h3>`;

testMethod(rangeUrn, "urn.splitRange()", ((rangeUrn.splitRange()[0].toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:1.1") && (rangeUrn.splitRange()[1].toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:3.3")) );
...
testMethod(rangeUrn, "urn.rangeFrom()", rangeUrn.rangeFrom().toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:1.1" );

testMethod(rangeUrn, "urn.rangeStart()", rangeUrn.rangeStart().toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:1.1" );

// rangeTo(), rangeEnd()
targetElement.innerHTML += `<h3>rangeTo()</h3>`;

testMethod(rangeUrn, "urn.rangeTo()", rangeUrn.rangeTo().toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:3.3" );

testMethod(rangeUrn, "urn.rangeEnd()", rangeUrn.rangeEnd().toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:3.3" );
...
testMethod(testUrn1, "urn.makeRange()", testUrn1.makeRange(testUrn2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1-2" );

testMethod(testUrn3, "urn.makeRange()", testUrn3.makeRange(testUrn4) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2-3.4" );

testMethod(testRange1, "urn.makeRange()", testRange1.makeRange(testRange2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.1-4.4" );
...
testMethod(exemplarUrn, "urn.versionLevelUrn()", exemplarUrn.versionLevelUrn().toString() == "urn:cts:greekLit:tlg0012.tlg001.allen:" );
...
testMethod(exemplarUrn, "urn.workLevelUrn()", exemplarUrn.workLevelUrn().equals(workUrn) );

testMethod(versionUrn, "urn.workLevelUrn()", versionUrn.workLevelUrn().equals(workUrn) );
...
testMethod(testUrn1, `urn.versionFromExemplar() == ${testUrn2.toString()} `, testUrn1.versionFromExemplar().toString() == testUrn2.toString() );
...
testMethod(testUrn2, `urn.versionFromExemplar() == ${testUrn1.toString()} `, testUrn2.addExemplar("tok").toString() == testUrn1.toString() );
...
testMethod(testUrn1, `urn.addPassage(${validPass1}) == ${testUrn1.toString() + validPass1} `, testUrn1.addPassage(validPass1).toString() == `${testUrn1.toString() + validPass1}` );

testMethod(testUrn1, `urn.addPassage(${validPass2}) == ${testUrn1.toString() + validPass2} `, testUrn1.addPassage(validPass2).toString() == `${testUrn1.toString() + validPass2}` );

testMethod(testUrn2, `urn.addPassage(${validPass2}) == ${testUrn1.toString() + validPass2} `, testUrn2.addPassage(validPass2).toString() == `${testUrn1.toString() + validPass2}` );
...
testMethod(testUrn0, "urn.chopPassage()", testUrn0.chopPassage() == "urn:cts:greekLit:tlg0012.tlg001.allen:" );

testMethod(testUrn1, "urn.chopPassage()", testUrn1.chopPassage() == "urn:cts:greekLit:tlg0012.tlg001.allen:" );

testMethod(testUrn2, "urn.chopPassage()", testUrn2.chopPassage() == "urn:cts:greekLit:tlg0012.tlg001.allen:1" );

testMethod(testUrn3, "urn.chopPassage()", testUrn3.chopPassage() == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2" );
...
testMethod(testUrn0, "urn.extendPassage()", testUrn0.extendPassage("x") == "urn:cts:greekLit:tlg0012.tlg001.allen:x" );

testMethod(testUrn1, "urn.extendPassage()", testUrn1.extendPassage("x") == "urn:cts:greekLit:tlg0012.tlg001.allen:1.x" );

testMethod(testUrn3, "urn.extendPassage()", testUrn3.extendPassage("x") == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2.x" );
...
testMethod(pi4, `urn.passageToDepth(2) => "1.2"`, pi4.passageToDepth(2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2" );

testMethod(pi4, `urn.passageToDepth(2) => "1.2"`, pi4.passageToDepth(2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2" );

testMethod(r3, `urn.passageToDepth(2) => "1.2-4.5"`, r3.passageToDepth(2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2-4.5" );

testMethod(r4, `urn.passageToDepth(2) => "1.2-5.6"`, r4.passageToDepth(2) == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2-5.6" );
...
testMethod(u1, `urn.equalizePassageDepths()`, (u1.equalizePassageDepths(u2)[0] == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2") );

testMethod(u1, `urn.equalizePassageDepths()`, (u1.equalizePassageDepths(u2)[1] == "urn:cts:greekLit:tlg0012.tlg001.allen:a.b") );

testMethod(r1, `urn.equalizePassageDepths()`, (r1.equalizePassageDepths(r2)[0] == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2.3-5.6.7") );

testMethod(r1, `urn.equalizePassageDepths()`, (r1.equalizePassageDepths(r2)[1] == "urn:cts:greekLit:tlg0012.tlg001.allen:a.b.c-d.e.f") );

testMethod(u1, `urn.equalizePassageDepths()`, (u1.equalizePassageDepths(r2)[0] == "urn:cts:greekLit:tlg0012.tlg001.allen:1.2") );

testMethod(u1, `urn.equalizePassageDepths()`, (u1.equalizePassageDepths(r2)[1] == "urn:cts:greekLit:tlg0012.tlg001.allen:a.b-d.e") );
