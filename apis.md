...
`Cite2Urn.equals(other: Cite2Urn)` - Returns `true` if `this.toString() == other.toString()`. When comparing a `Cite2Urn` to a `String` with *e.g.* `===` comparison is based on the `.urnString` property.
